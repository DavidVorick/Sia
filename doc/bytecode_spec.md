...
| 0x22 | move          | 2    | move instruction pointer by offset $1$2                                                |
| ---- | ----          | -    | data pointer and register opcodes                                                      |
| 0x30 | reg_store     | 1    | pop a stack value into register $1                                                     |
| 0x31 | reg_load      | 1    | push a stack value from register $1                                                    |
...
| 0x42 | make_wallet   | 1    | add a wallet with an initial balance and script                                        |
...
| 0xE1 | data_prefix   | 1    | same as data_copy, but using the first two bytes to determine the length               |
| 0xE2 | data_rest     | 1    | copy from data pointer to end of script into register $1                               |
| 0xE3 | cond_reject   | 0    | if false, reject (otherwise no op)                                                     |
| ---- | ----          | -    | termination opcodes                                                                    |
