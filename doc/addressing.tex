...
% This section should really be discussed after total topology is discussed.
...
When a block is integrated, hosts will receive rewards for successfully completing the proof of storage and proof of capacity elements of consensus.
The random numbers in the heartbeats will be appended in a specific order and hashed, to create a unique random seed for the quorum.
