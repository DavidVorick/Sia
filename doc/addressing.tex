...
The quorum as a whole is responsible for tracking a portion of the network topology.
The quorum is responsible for the files stored within the quorum, as well as keeping all of the hosts within the quorum honest.
Additionally, a portion of the wallets on the network will be stored on each quorum (such that each wallet only appears in a single quorum).

Because quorums are responsible for managing data that only they are required to store, steps must be taken to guarantee the honesty of quorums.
